...
<body>
<h1 style="text-align:center; padding-top: 40px;">KATEGORI OBAT</h1>
<style>* {
...
<?php
            ...
            while ($data = mysqli_fetch_array($query)){
                ...
                <a href="editkategori.php?id=<?php echo $data ['id_kategori']?>" class="edit-button">Edit</a>
                <a href="deletekategori.php?id=<?php echo $data ['id_kategori']?>" class="delete-button">Delete</a>
            </td>
            </tr>
            <?php
            $no++;
    ...
    <a href="tambahkategori.php" class="add-button">Tambah</a>
</div>
</main>
<div class="sidebar">
