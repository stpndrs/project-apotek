    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
          <button class="btn-update" onclick="openUpdateModal(<?php echo $data['id_jenis']; ?>, '<?php echo $data['nama_jenis']; ?>')">Update</button>
          <button class="btn-delete" onclick="deleteRak(<?php echo $data['id_jenis']; ?>)">Delete</button>
          </td>
        </tr>
        <?php
        }
...
<div id="myModal" class="modal">
  <div class="modal-content">
    ...
    <form method="post" action="insert_jenis.php">
      <label for="jenisNama">Nama Jenis:</label>
      <input type="text" id="jenisNama" name="jenisNama"><br><br>
...
<div id="myModalUpdate" class="modal">
  <div class="modal-content">
    ...
    <form id="updateForm" method="post" action="update_jenis.php">
      <input type="hidden" id="updateId" name="updateId">
      <label for="updatejenisNama">Nama Jenis:</label>
      <input type="text" id="updatejenisNama" name="updatejenisNama"><br><br>
...
<script>
  ...
  function openUpdateModal(id, jenisNama) {
    var modal = document.getElementById("myModalUpdate");
    var updateIdField = document.getElementById("updateId");
    var updatejenisNamaField = document.getElementById("updatejenisNama");

    updateIdField.value = id;
    updatejenisNamaField.value = jenisNama;
  ...
  function deleteRak(id) {
    if (confirm("Are you sure you want to delete this record?")) {
      window.location.href = "deletejenis.php?id_jenis=" + id;
    }
  }
</script>
</body>
