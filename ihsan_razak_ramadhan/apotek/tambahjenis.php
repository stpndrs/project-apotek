...
if (isset($_POST['submit'])) {
  ...
  $query = mysqli_query($connect, "SELECT * FROM tb_jenisobat WHERE jenis_obat='$jenis'");
...
?>
    ...
    $query = mysqli_query($connect, "INSERT INTO tb_jenisobat (jenis_obat) VALUES ('$jenis') ");
    if ($query) {
    ?>
      <script type="text/javascript">
        $(document).ready(function() {
                  ...
                  <form action="" method="POST">
                    <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <input type="text" class="form-control" id="txtjenis" name="txtjenis" value="<?= (isset($jenis)) ? $jenis : ''; ?>" autocomplete="off" required>
                      </div>
