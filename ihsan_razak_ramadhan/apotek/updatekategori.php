...
$id = $_GET['id'];
$query = mysqli_query($connect, "SELECT * FROM tb_kategoriobat WHERE id_kategori = $id");
$data = mysqli_fetch_array($query);

if (isset($_POST['update'])) {
    $kategori = $_POST['txtkategori'];

    $query = mysqli_query($connect, "UPDATE tb_kategoriobat SET kategori_obat = '$kategori' WHERE id_kategori = $id");
...
?>
      ...
      <script type="text/javascript">
        $(document).ready(function() {
          swal("Error", "Gagal Mengubah Data Kategori Obat", "warning");
        });
      </script>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <input type="text" class="form-control" value="<?php echo $data['kategori_obat'] ?>" id="txtkategori" name="txtkategori" autocomplete="off" required>
                            </div>
