  ...
  <body class="">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <table class="table table-striped table-bordered table-hover text-black">
                            ...
                            <tbody>
                                ...
                                include 'config.php';
                                $n = 1;
                                $data_karyawan = mysqli_query($connect,"SELECT * FROM tb_karyawan ORDER BY id_karyawan asc");
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10%;"><?= $data['nik_karyawan'] ?></td>
                                    <td style="width: 20%;"><?= $data['nama_karyawan'] ?></td>
                                    <td style="width: 15%;"><?= $data['tmpt_lahir'] ?></td>
                                    <td style="width: 15%;"><?= $data['tgl_lahir'] ?></td>
                                    <td style="width: 20%;"><?= $data['alamat'] ?></td>
                                    <td style="width: 10%;"><?= $data['no_telp'] ?></td>
                                    <td style="width: 8%;">
                                        <a href="updatekaryawan.php?id=<?php echo $data['id_karyawan']?>" class="btn btn-success btn-sm">Ubah</a>
                                        <a href="#" id="<?php echo $data['id_karyawan']?>" class="btn btn-danger btn-sm hapuskaryawan">Hapus</a>
                                    </td>
                                </tr>
                                <?php
                                }
    ...
    $(document).ready(function() {
      $(document).on('click', '.hapuskaryawan', function() {
        ...
        swal({
            title: "Hapus",
            text: "Yakin data Karyawan akan dihapus?",
            type: 'question',
            ...
            if (result.value) {
                ...
                swal('Batal', 'Data Karyawan batal dihapus', 'error');
                return false;
            }
        });
      });
