            ...
            <div class="card-body p-0">
              <div class="row" style="margin: 20px;">
                <div class="col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 20px;">
                  ...
                  <a href="tambahjenis.php" class="btn btn-success" style="margin-left: 5px;">Tambah Data</a>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <table class="table table-striped table-bordered table-hover text-black">
                    <thead>
                      <tr style="text-align: center; font-weight: bold;">
                        ...
                        <th style="width: 90%;">Jenis Obat</th>
                    ...
                    <tbody>
                      ...
                      include 'config.php';
                      $n = 1;
                      $jenis_obat = mysqli_query($connect, "SELECT * FROM tb_jenisobat ORDER BY id_jenis asc");
                      if (mysqli_num_rows($jenis_obat) > 0) {
                        while ($data = mysqli_fetch_array($jenis_obat)) {

                      ?>
                          <tr>
                            <td style="width: 1%;"><?= $n++ ?></td>
                            <td style="width: 90%;"><?= $data['jenis_obat'] ?></td>
                            <td style="width: 9%;">
                              <a href="updatejenis.php?id=<?php echo $data['id_jenis'] ?>" class="btn btn-success btn-sm">Ubah</a>
                              <a href="#" id="<?php echo $data['id_jenis'] ?>" class="btn btn-danger btn-sm hapusjenis">Hapus</a>
                            </td>
                          </tr>
                        <?php
                        }
  ...
  <script>
    $(document).ready(function() {
      $(document).on('click', '.hapusjenis', function() {
        ...
        swal({
            title: "Hapus",
            text: "Yakin data Jenis Obat akan dihapus?",
            type: 'question',
            ...
            if (result.value) {
                    ...
                    success: function(dataResult) {
                        ...
                        if (dtResult.statusCode == 200) {
                          swal({
                            ...
                            if (result.value) {
                              window.location.href = 'jenisobat.php';
                            }
                          });
                          return;
                        } else {
                ...
                swal('Batal', 'Data Jenis Obat batal dihapus', 'error');
                return false;
            }
        });
      });
