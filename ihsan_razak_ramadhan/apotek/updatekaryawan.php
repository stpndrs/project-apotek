...
$id = $_GET['id'];
$query = mysqli_query($connect, "SELECT * FROM tb_karyawan WHERE id_karyawan = $id");
...
if (isset($_POST['update'])) {
  ...
  $notelp = $_POST['txtnotelp'];
      ...
      $query = mysqli_query($connect, "UPDATE tb_karyawan SET nik_karyawan = '$nik', nama_karyawan  = '$nama',
    tmpt_lahir = '$tmpt', tgl_lahir = '$tgl', alamat = '$alamat', no_telp = '$notelp' WHERE id_karyawan = $id");
...
?>
      ...
      <script type="text/javascript">
        $(document).ready(function() {
          swal("Error", "Gagal Mengubah Data Karyawan", "warning");
        });
      </script>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                ...
                                <input type="text" class="form-control" value="<?php echo $data['nik_karyawan'] ?>" id="txtnik" name="txtnik" autocomplete="off" required><br>
                            </div>
                            <div class="col-lg-8 col-md-8 col-sm-12">
                                <label for="txtnama">Nama</label>
                                <input type="text" class="form-control" value="<?php echo $data['nama_karyawan'] ?>" id="txtnama" name="txtnama" autocomplete="off" required><br>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="txttmpt">Tempat Lahir</label>
                                <input type="text" class="form-control" value="<?php echo $data['tmpt_lahir'] ?>" id="txttmpt" name="txttmpt" autocomplete="off" required><br>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="txttgl">Tanggal Lahir</label>
                                <input type="date" class="form-control" value="<?php echo $data['tgl_lahir'] ?>" id="txttgl" name="txttgl" autocomplete="off" required><br>
                            </div>
                            <div class="col-lg-8 col-md-8 col-sm-12">
                                <label for="txtalamat">Alamat</label>
                                <input type="text" class="form-control" value="<?php echo $data['alamat'] ?>" id="txtalamat" name="txtalamat" autocomplete="off" required><br>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <label for="txtnotelp">No. Telepon</label>
                                <input type="text" class="form-control" value="<?php echo $data['no_telp'] ?>" id="txtnotelp" name="txtnotelp" autocomplete="off" required><br>
                            </div>
