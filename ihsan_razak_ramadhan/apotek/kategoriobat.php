  ...
  <body class="">
              ...
              <div class="card-body p-0">
                <div class="row" style="margin: 20px;">
                    <div class="col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 20px;">
                        <a href="kategoriobat.php" class="btn btn-primary">Tabel</a>
                        <a href="tambahkategori.php" class="btn btn-success" style="margin-left: 5px;">Tambah Data</a>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <table class="table table-striped table-bordered table-hover text-black">
                            <thead>
                                <tr style="text-align: center; font-weight: bold;">
                                    ...
                                    <th style="width: 90%;">Kategori Obat</th>
                            ...
                            <tbody>
                                ...
                                include 'config.php';
                                $n = 1;
                                $kategori_obat = mysqli_query($connect,"SELECT * FROM tb_kategoriobat ORDER BY id_kategori asc");
                                if(mysqli_num_rows($kategori_obat)>0){
                                while($data = mysqli_fetch_array($kategori_obat)) {
                                
                                ?>
                                <tr>
                                    <td style="width: 1%;"><?= $n++ ?></td>
                                    <td style="width: 90%;"><?= $data['kategori_obat'] ?></td>
                                    <td style="width: 9%;">
                                        <a href="updatekategori.php?id=<?php echo $data['id_kategori']?>" class="btn btn-success btn-sm">Ubah</a>
                                        <a href="#" id="<?php echo $data['id_kategori'] ?>" class="btn btn-danger btn-sm hapuskategori">Hapus</a>
                                    </td>
                                </tr>
                                <?php
                                }
    ...
    $(document).ready(function() {
      $(document).on('click', '.hapuskategori', function() {
        ...
        swal({
            title: "Hapus",
            text: "Yakin data Kategori Obat akan dihapus?",
            type: 'question',
            ...
            if (result.value) {
                    ...
                    success: function(dataResult) {
                        ...
                        if (dtResult.statusCode == 200) {
                          swal({
                            ...
                            if (result.value) {
                              window.location.href = 'kategoriobat.php';
                            }
                          });
                          return;
                        } else {
                ...
                swal('Batal', 'Data Kategori Obat batal dihapus', 'error');
                return false;
            }
        });
      });
