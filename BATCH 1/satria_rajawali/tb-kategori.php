    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
          <button class="btn-update" onclick="openUpdateModal(<?php echo $data['id_kategori']; ?>, '<?php echo $data['nama_kategori']; ?>')">Update</button>
          <button class="btn-delete" onclick="deletekategori(<?php echo $data['id_kategori']; ?>)">Delete</button>
          </td>
        </tr>
        <?php
        }
...
<div id="myModal" class="modal">
  <div class="modal-content">
    ...
    <form method="post" action="insert_kategori.php">
      ...
      <input type="text" id="kategoriNama" name="kategoriNama"><br><br>
...
<div id="myModalUpdate" class="modal">
  <div class="modal-content">
    ...
    <form id="updateForm" method="post" action="update_kategori.php">
      <input type="hidden" id="updateId" name="updateId">
      <label for="updatekategoriNama">Nama Kategori:</label>
      <input type="text" id="updatekategoriNama" name="updatekategoriNama"><br><br>
...
<script>
  ...
  function openUpdateModal(id, kategoriNama) {
    var modal = document.getElementById("myModalUpdate");
    var updateIdField = document.getElementById("updateId");
    var updatekategoriNamaField = document.getElementById("updatekategoriNama");

    updateIdField.value = id;
    updatekategoriNamaField.value = kategoriNama;
  ...
  function deletekategori(id) {
    if (confirm("Are you sure you want to delete this record?")) {
      window.location.href = "deletekategori.php?id_kategori=" + id;
    }
  }
</script>
</body>
