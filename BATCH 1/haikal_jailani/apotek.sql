...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Bulan Mei 2023 pada 16.18
...
INSERT INTO `obat` (`nama_obat`, `keterangan`, `id_jenis`, `stock_obat`, `id_kategori_obat`, `id_rak_obat`, `id_obat`, `harga_jual`, `status`) VALUES
('pracetamol', 'demam', 2, 2, 2, 1, 1, '10.000', '');
...
INSERT INTO `rak_obat` (`id_rak`, `no_rak`) VALUES
(1, 'Rak A'),
(2, 'Rak A2');
