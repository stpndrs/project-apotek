...
<body>
    ...
    <div class="content-container">
        <a href="obatAdd.php" class="cta" style="margin-left: 20px;"><button>+Add New</button></a>
      ...
      <?php
        ...
        <tr>
            ...
            <span class="action_btn">
              <a href="obatEdit.php?id_obat=<?php echo $data['id_obat']?>">Edit</a>
              <a href="obatRemove.php?id_obat=<?php echo $data['id_obat']?>" onclick="return confirmDelete()">Remove</a>
            </span>
          </td>
        </tr>
        <?php
