...
public class Penjualan extends javax.swing.JFrame {
    ...
    private void autonumber(){
        try {
            ...
            if (r.next()) {
                ...
                {Nol = "";}
                txNoFakturi.setText("TR" + Nol + TR);
            } else {
                txNoFakturi.setText("TR0001");
            }
            r.close();
            s.close();
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        txNoFakturi = new javax.swing.JTextField();
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(21, 21, 21)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txRak, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(jLabel6))
                                        .addGap(18, 18, 18)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txNamaObat, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(txNoFakturi, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel2)
                            .addComponent(txNoFakturi, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        String NoFaktur = txNoFakturi.getText();
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = ("Insert into transaksi (NoFaktur,tanggal,namacustomer,TotalBeli) values (?, ?, ?, ?)");
        ...
        try {
            ...
            for (int i = 0; i < baris; i++) {
                String sql = "INSERT INTO detailtransaksi(NoFaktur, RakObat, NamaObat, Jumlah, Harga, Total) VALUES('"
            ...
            System.out.println("detail transaksi error");
        }
        clear();
        utama();
        autonumber();
    ...
    private javax.swing.JTextField txNoFakturi;
    public static javax.swing.JTextField txRak;
