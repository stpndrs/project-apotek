...
public class ListObat extends javax.swing.JFrame {
    ...
    public void cari(){
       ...
       tabel.addColumn("RakObat");
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "Select * from obat where RakObat like '%" + txCari.getText() + "%'" +
                    "or NamaObat like '%" + txCari.getText() + "%'";
    ...
    private void btnPilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPilihActionPerformed
        ...
        Penjualan.txRak.setText(id);
        Penjualan.txNamaObat.setText(nama);
