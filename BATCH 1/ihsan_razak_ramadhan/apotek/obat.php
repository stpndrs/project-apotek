              ...
              <div class="card-body p-0">
                <div class="row" style="margin: 20px;">
                    <div class="col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 20px;">
                        ...
                        <a href="tambahobat.php" class="btn btn-success" style="margin-left: 5px;">Tambah Data</a>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <table class="table table-striped table-bordered table-hover text-black">
                            <thead>
                                <tr style="text-align: center; font-weight: bold;">
                                    ...
                                    <th style="width: 10%;">Harga Obat</th>
                            ...
                            <tbody>
                                ...
                                include 'config.php';
                                $n = 1;
                                $obat = mysqli_query($connect,"SELECT * FROM vw_obat ORDER BY id_obat asc");
                                ...
                                <tr>
                                    ...
                                    <td style="width: 40%;"><?= $data['nama_obat']; ?></td>
                                    <td style="width: 10%;"><?= $data['jenis_obat']; ?></td>
                                    <td style="width: 10%;"><?= $data['kategori_obat']; ?></td>
                                    <td style="width: 10%;"><?= $data['lokasi_obat']; ?></td>
                                    <td style="width: 10%;"><?= $data['harga']; ?></td>
                                    <td style="width: 5%;"><?= $stok; ?></td>
                                    <td style="width: 10%;"><?= $data['status_obat']; ?></td>
                                    <td style="width: 9%;">
                                        <a href="updateobat.php?id=<?php echo $data['id_obat']?>" class="btn btn-success btn-sm">Ubah</a>
                                        <a href="#" id="<?php echo $data['id_obat']?>" class="btn btn-danger btn-sm hapusobat">Hapus</a>
                                    </td>
                                </tr>
                                <?php
                                }
      ...
      $(document).on('click', '.hapusobat', function() {
        ...
        swal({
            ...
            if (result.value) {
                ...
                swal('Batal', 'Data Obat batal dihapus', 'error');
                return false;
            }
        });
      });
