...
$id = $_GET['id'];
$query = mysqli_query($connect, "SELECT * FROM vw_obat WHERE id_obat = $id");
$data = mysqli_fetch_assoc($query);

if (isset($_POST['update'])) {
    $stok = $_POST['txtstok'];

    $query = mysqli_query($connect, "UPDATE tb_stokobat SET stok_obat = $stok WHERE id_stok = $id");
...
?>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        swal("Error", "Gagal Mengubah Data Stok Obat", "warning");
      });
    </script>
                ...
                <div class="row" style="margin: 20px;">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" value="<?php echo $data['nama_obat'] ?>" id="txtnama" name="txtnama" autocomplete="off" disabled><br>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="txtjenis">Jenis</label>
                                <input type="text" class="form-control" value="<?php echo $data['jenis_obat'] ?>" id="txtjenis" name="txtjenis" autocomplete="off" disabled><br>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="txtkategori">Kategori</label>
                                <input type="text" class="form-control" value="<?php echo $data['kategori_obat'] ?>" id="txtkategori" name="txtkategori" autocomplete="off" disabled><br>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="txtstok">Stok Obat</label>
                                <input type="text" class="form-control" value="<?php echo $data['stok_obat'] ?>" id="txtstok" name="txtstok" autocomplete="off" required>
                            </div>
