...
if (isset($_POST['submit'])) {
  $id_obat = $_POST['txtnama'];
  $stok = $_POST['txtstok'];
  $query = mysqli_query($connect, "SELECT * FROM tb_stokobat WHERE id_obat = $id_obat");
  if (mysqli_num_rows($query) > 0) {
    $rw = mysqli_fetch_assoc($query);
    $id_stok = $rw['id_stok'];
    $stokawal = $rw['stok_obat'];
    $stokakhir = $stokawal + $stok;
    $query = mysqli_query($connect, "UPDATE tb_stokobat SET stok_obat = $stokakhir WHERE id_stok = $id_stok");
    if($query){
?>
...
<?php
    ...
    $query = mysqli_query($connect, "INSERT INTO tb_stokobat (stok_obat, id_obat) VALUES ($stok, $id_obat) ");
    if ($query) {
    ?>
      <script type="text/javascript">
        $(document).ready(function() {
            ...
            <div class="card-body p-0">
              <div class="row" style="margin: 20px;">
                <div class="col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 20px;">
                  <a href="stokobat.php" class="btn btn-primary">Tabel</a>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <form action="" method="POST">
                    <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="alert alert-danger errormsg animate__animated animate__bounce d-none mb-3"></div>
                                <label for="txtnama">Nama Obat</label>
                                <select type="text" class="form-control" id="txtnama" name="txtnama" autocomplete="off">
                                    <option value="">Pilih Nama Obat</option>
                                    <?php
                                    $query_obat = mysqli_query($connect, "SELECT * FROM tb_obat");
                      ...
                      <div class="col-lg-3 col-md-3 col-sm-12">
                        ...
                        <input type="text" class="form-control" id="txtjenis" name="txtjenis" autocomplete="off" required disabled><br>
                      </div>
                      <div class="col-lg-3 col-md-3 col-sm-12">
                        <label for="txtkategori">Kategori Obat</label>
                        <input type="text" class="form-control" id="txtkategori" name="txtkategori" autocomplete="off" required disabled><br>
                      </div>
                      <div class="col-lg-3 col-md-3 col-sm-12">
                        <label for="txtlokasi">Lokasi Obat</label>
                        <input type="text" class="form-control" id="txtlokasi" name="txtlokasi" autocomplete="off" required disabled><br>
                      </div>
                      <div class="col-lg-3 col-md-3 col-sm-12">
                        <label for="txtstok">Stok Obat</label>
                        <input type="number" class="form-control" id="txtstok" name="txtstok" autocomplete="off" required><br>
                      </div>
                      <div class="col-lg-12 col-md-12 col-sm-12" style="margin-top: 20px;">
                        <input type="submit" value="Simpan Stok" class="btn btn-primary" name="submit">
                      </div>
                    </div>
                  </form>
                </div>
      ...
      $("#txtnama").change(function() {
        ...
        $.ajax({
            ...
            error: function(xhr, ajaxOptions, thrownError) {
                ...
                if (thrownError != "") {
                    $(".errormsg").html("Terjadi kesalahan saat load data obat");
                    $("#").remove();
                }
            }
        });
