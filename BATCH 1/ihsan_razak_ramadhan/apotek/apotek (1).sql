...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Bulan Mei 2023 pada 16.59
...
(3, 'Paracetamol', 10000, 9, 4, 2, 'Non-Aktif'),
(11, 'Paramex', 70000, 3, 3, 2, 'Aktif'),
(12, 'KSR 600', 40000, 9, 2, 3, '');
...
ALTER TABLE `tb_obat`
  ...
  ADD UNIQUE KEY `id_jenis` (`id_jenis`,`id_lokasi`),
...
ALTER TABLE `tb_obat`
  ...
  ADD CONSTRAINT `tb_obat_ibfk_5` FOREIGN KEY (`id_jenis`) REFERENCES `tb_jenisobat` (`id_jenis`) ON DELETE CASCADE ON UPDATE CASCADE,
