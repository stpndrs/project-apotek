...
<html lang="en">
  ...
  <body class="">
              ...
              <div class="card-body p-0">
                <div class="row" style="margin: 20px;">
                    <div class="col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 20px;">
                        ...
                        <a href="tambahlokasi.php" class="btn btn-success" style="margin-left: 5px;">Tambah Data</a>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <table class="table table-striped table-bordered table-hover text-black">
                            <thead>
                                <tr style="text-align: center; font-weight: bold;">
                                    ...
                                    <th style="width: 90%;">lokasi Obat</th>
                            ...
                            <tbody>
                                ...
                                include 'config.php';
                                $n = 1;
                                $lokasi_obat = mysqli_query($connect,"SELECT * FROM tb_lokasiobat ORDER BY id_lokasi asc");
                                if(mysqli_num_rows($lokasi_obat)>0){
                                while($data = mysqli_fetch_array($lokasi_obat)) {
                                
                                ?>
                                <tr>
                                    <td style="width: 1%;"><?= $n++ ?></td>
                                    <td style="width: 90%;"><?= $data['lokasi_obat'] ?></td>
                                    <td style="width: 9%;">
                                        <a href="updatelokasi.php?id=<?php echo $data['id_lokasi']?>" class="btn btn-success btn-sm">Ubah</a>
                                        <a href="#" id="<?php echo $data['id_lokasi']?>" class="btn btn-danger btn-sm hapuslokasi">Hapus</a>
                                    </td>
                                </tr>
                                <?php
                                }
    ...
    $(document).ready(function() {
      $(document).on('click', '.hapuslokasi', function() {
        var id_lokasi=$(this).attr('id');

        swal({
            title: "Hapus",
            text: "Yakin data Lokasi Obat akan dihapus?",
            type: 'question',
            ...
            if (result.value) {
                ...
                swal('Batal', 'Data Lokasi Obat batal dihapus', 'error');
                return false;
            }
        });
      });
