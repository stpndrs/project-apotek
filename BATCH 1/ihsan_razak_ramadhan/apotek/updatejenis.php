...
$id = $_GET['id'];
$query = mysqli_query($connect, "SELECT * FROM tb_jenisobat WHERE id_jenis = $id");
$data = mysqli_fetch_array($query);

if (isset($_POST['update'])) {
    $jenis = $_POST['txtjenis'];

    $query = mysqli_query($connect, "UPDATE tb_jenisobat SET jenis_obat = '$jenis' WHERE id_jenis = $id");
...
?>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        swal("Error", "Gagal Mengubah Data Jenis Obat", "warning");
      });
    </script>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <input type="text" class="form-control" value="<?php echo $data['jenis_obat'] ?>" id="txtjenis" name="txtjenis" autocomplete="off" required>
                            </div>
