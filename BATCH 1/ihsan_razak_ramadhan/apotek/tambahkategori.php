...
if(isset($_POST['submit'])) {
    ...
    $query = mysqli_query($connect,"SELECT * FROM tb_kategoriobat WHERE kategori_obat='$kategori'");
...
<?php
        ...
        $query = mysqli_query($connect, "INSERT INTO tb_kategoriobat (kategori_obat) VALUES ('$kategori') ");
...
?>
      ...
      $(document).ready(function() {
        swal({
          ...
          if (result.value) {
            window.location.href = 'tambahkategori.php';
          }
        });
        return;
      });
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="txtkategori" name="txtkategori" autocomplete="off" required>
                            </div>
