  ...
  <body class="">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <table class="table table-striped table-bordered table-hover text-black">
                            ...
                            <tbody>
                                ...
                                include 'config.php';
                                $n = 1;
                                $user_obat = mysqli_query($connect,"SELECT * FROM vw_user ORDER BY id_user asc");
                                if(mysqli_num_rows($user_obat)>0){
                                while($data = mysqli_fetch_array($user_obat)) {
                                
                                ?>
                                <tr>
                                    <td style="width: 1%;"><?= $n++ ?></td>
                                    <td style="width: 35%;"><?= $data['email'] ?></td>
                                    <td style="width: 35%;"><?= $data['nama_karyawan'] ?></td>
                                    <td style="width: 20%;"><?= $data['akses_obat'] ?></td>
                                    <td style="width: 9%;">
                                        <a href="updateuser.php?id=<?php echo $data['id_user']?>" class="btn btn-success btn-sm">Ubah</a>
                                        <a href="#" id="<?php echo $data['id_user']?>" class="btn btn-danger btn-sm hapususer">Hapus</a>
                                    </td>
                                </tr>
                                <?php
                                }
    ...
    $(document).ready(function() {
      $(document).on('click', '.hapususer', function() {
        ...
        swal({
            title: "Hapus",
            text: "Yakin data User akan dihapus?",
            type: 'question',
            ...
            if (result.value) {
                ...
                swal('Batal', 'Data User Obat batal dihapus', 'error');
                return false;
            }
        });
      });
