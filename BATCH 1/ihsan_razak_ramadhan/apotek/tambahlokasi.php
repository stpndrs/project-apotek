...
if(isset($_POST['submit'])) {
    ...
    $query = mysqli_query($connect,"SELECT * FROM tb_lokasiobat WHERE lokasi_obat='$lokasi'");
...
<?php
        ...
        $query = mysqli_query($connect, "INSERT INTO tb_lokasiobat (lokasi_obat) VALUES ('$lokasi') ");
...
?>
      ...
      $(document).ready(function() {
        swal({
          ...
          if (result.value) {
            window.location.href = 'tambahlokasi.php';
          }
        });
        return;
      });
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="txtlokasi" name="txtlokasi" autocomplete="off" required>
                            </div>
