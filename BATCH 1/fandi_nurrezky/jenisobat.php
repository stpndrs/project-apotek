...
<body>
<h1 style="text-align:center; padding-top: 40px;">JENIS OBAT</h1>
<style>* {
...
<table>
    ...
    <?php
            ...
            while ($data = mysqli_fetch_array($query)){
                ...
                <a href="editjenis.php?id=<?php echo $data['id_jenis']?>" class="edit-button">Edit</a>
                <a href="deletejenis.php?id=<?php echo $data ['id_jenis']?>" class="delete-button">Delete</a>
            </td>
            </tr>
            <?php 
            $no++;
    ...
    <a href="tambahjenis.php" class="add-button">Tambah</a>
</div>
</main>
<div class="sidebar">
