...
<body>
<h1 style="text-align:center; padding-top: 40px;">RAK OBAT</h1>
<style>* {
...
<?php
            ...
            while ($data = mysqli_fetch_array($query)){
                ...
                <td> <?php echo $data ['alamat_rak'] ?> </td>
                <td class="action-buttons">
                <a href="editrak.php?id=<?php echo $data ['id_rak']?>" class="edit-button">Edit</a>
                <a href="deleterak.php?id=<?php echo $data ['id_rak']?>" class="delete-button">Delete</a>
            </td>
            </tr>
            <?php
            $no++;
    ...
    <a href="tambahrak.php" class="add-button">Tambah</a>
</div>
</main>
<div class="sidebar">
